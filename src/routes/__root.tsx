...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A rule-based fraud operations console for prioritizing risk and reviewing cases." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Fraud Triage Copilot | Fraud Operations" },
      { property: "og:description", content: "A rule-based fraud operations console for prioritizing risk and reviewing cases." },
